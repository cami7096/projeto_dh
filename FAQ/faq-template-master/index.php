...
<section class="cd-faq">
	...
	<div class="cd-faq-items">
		<ul id="basics" class="cd-faq-group">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Como faço para me inscrever?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Como removo um post?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Como as revisões funcionam?</a>
				<div class="cd-faq-content">
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
				</div> <!-- cd-faq-content -->
			</li>
		...
		<ul id="mobile" class="cd-faq-group">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Como faço upload de arquivos do meu celular ou tablet?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Como faço para vincular a um arquivo ou pasta?</a>
				<div class="cd-faq-content">
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
				</div> <!-- cd-faq-content -->
			</li>
		...
		<ul id="account" class="cd-faq-group">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Como faço para excluir minha conta?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Como faço para alterar minhas configurações de conta?</a>
				<div class="cd-faq-content">
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
				</div> <!-- cd-faq-content -->
			</li>
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Esqueci a minha senha. Como redefino isso?</a>
				<div class="cd-faq-content">
		...
		<ul id="delivery" class="cd-faq-group">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Como posso encontrar suas informações de entrega internacional?</a>
				<div class="cd-faq-content">
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
				</div> <!-- cd-faq-content -->
			</li>
